  ...
  return (
    <main className="  w-full">
      ...
      >
        ...
        <div className="flex-2 bg-banner  w-screen h-[90%] bg-cover">
          <Navbar />
        </div>
      </div>

      <div className="w-full max-w-screen-lg text-center mx-auto pb-10 ">
        <h1 className="uppercase text-4xl font-extrabold tracking-wider mb-6 ">
          YOUR BURGER-SNACKS POINT IN BERLIN
        </h1>
        <h3 className="uppercase text-2xl font-semibold tracking-wide mb-12">
          HOMEMADE MINI-BURGERS & street food{" "}
          <BsFillHeartFill className="text-red-400 text-3xl mx-auto my-2" />{" "}
        </h3>
        <p className="font-light text-sm tracking-wide leading-6">
